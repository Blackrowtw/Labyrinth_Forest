...
#                id: "minecraft:llama",
#                CustomName: "庫斯德",
#                DeathLootTable: "labyrinth_forest:entities/Kuzco_llama",
#                Tags: [
#                    "Kuzco_llama",
#                    "L_F"
#                ],
