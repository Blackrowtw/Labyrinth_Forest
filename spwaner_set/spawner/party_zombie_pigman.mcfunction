...
#             "L_F"
#         ],
#         DeathLootTable: "Labyrinth_Forest:mobs/party_zombie_pigman",
#         Attributes: [
#             {
#                 Name: generic.armor,
#                 Base: 15
