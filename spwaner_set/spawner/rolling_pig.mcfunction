...
#                 id: "minecraft:pig",
#                 CustomName: "打滾豬",
#                 DeathLootTable: "labyrinth_forest:entities/rolling_pig",
#                 Tags: [
#                     "rolling_pig",
#                     "L_F"
#                 ],
