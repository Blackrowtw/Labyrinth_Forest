...
#                RabbitType: 1,
#                CustomName: "雪兔哥",
#                DeathLootTable: "labyrinth_forest:entities/snow_rabbit",
#                Tags: [
#                    "snow_rabbit",
#                    "L_F"
#                ],
