...
#                 CatType: 3,
#                 CustomName: "史塔克",
#                 DeathLootTable: "labyrinth_forest:entities/Stark_villager_golem",
#                 Tags: [
